...
And there is also the config.py file, tgis file consists of configurations that were used during the project. configrations like file path, numerical features and categorical features.
